...
var Selecto = function(_super) {
  ...
  function Selecto3(options) {
    ...
    _this._onDragStart = function(e, clickedTarget) {
      ...
      if (boundContainer) {
        var boundInfo = isObject(boundContainer) && "element" in boundContainer ? __assign5({
          left: true,
          top: true,
          bottom: true,
          right: true
      ...
      var result = !e.isClick && isTrusted ? _this.emit("dragStart", __assign5(__assign5({}, e), {
        data: data.data
      })) : true;
      if (!result) {
        e.stop();
      ...
      if (isPreventSelect && selectByClick && !clickBySelectEnd) {
        ...
        if (innerScrollOptions) {
          ...
          if (innerScrollElement) {
            data.innerScrollOptions = __assign5({
    ...
    _this._onDragEnd = function(e) {
      ...
      var container2 = _this.container;
      if (inputEvent) {
        _this.emit("dragEnd", __assign5(__assign5({
          isDouble: !!e.isDouble,
          isClick: !!e.isClick,
          isDrag: false,
          isSelect: selectFlag
  ...
  __proto.checkScroll = function() {
    ...
    var hasScrollOptions = innerScrollOptions || (scrollOptions === null || scrollOptions === void 0 ? void 0 : scrollOptions.container);
    if (hasScrollOptions) {
      this.dragScroll.checkScroll(__assign5({
  ...
  __proto._select = function(selectedTargets, rect, e, isStart, isDragStartEnd) {
    ...
    if (isStart) {
      this.emit("selectStart", __assign5(__assign5(__assign5({}, result), startResult), {
        rect,
        inputEvent,
        data: data.data,
    ...
    if (result.added.length || result.removed.length) {
      this.emit("select", __assign5(__assign5(__assign5({}, result), startResult), {
        rect,
        inputEvent,
        data: data.data,
        isTrusted: e.isTrusted,
  ...
  __proto._checkSelected = function(e, rect) {
    ...
    var result = this.emit("drag", __assign5(__assign5({}, e), {
      data: data.data,
      isSelect: selectFlag,
      rect
    }));
...
var Selecto2 = function(_super) {
  ...
  __proto.componentDidMount = function() {
    ...
    this.selecto = new selecto_esm_default(__assign6(__assign6({}, options), {
